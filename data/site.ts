...
export const heroSlides = [
  {
    ...
    desc:   "از باغ‌های سرسبز تا سفره‌های شما؛ هر قطره پانسی، حاصل سال‌ها تجربه، گزینش دقیق میوه و باور به طعمی اصیل است.",
...
export const homeProductCards = [
  {
    ...
    num:  "01",
    name: "رانی پرتقال",
    desc: "طعم تازه و سرشار از ویتامین C، در بسته‌بندی مطمئن و قفسه‌پسند.",
    img:  "/images/pansy-orange.png",
  },
  {
